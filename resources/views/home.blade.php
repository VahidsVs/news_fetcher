                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="whats-news-single mb-40 mb-40">
                                                    ...
                                                    <div class="whates-caption">
                                                        ...
                                                        <h5>source:<a href="{{ explode('_',$lastetPost->source)[1] }}">{{ explode('_',$lastetPost->source)[0]  }}</a></h5>
                                                        ...
                                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                            <div class="whats-right-single last-four-posts-parent mb-20">
                                                                ...
                                                                <div class="whats-right-cap">
                                                                    ...
                                                                    <p class="title-last-four-posts" style="" >source:<a href="{{ explode('_',$item->source)[1] }}" target="_blank">{{ explode('_',$item->source)[0] }}</a></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
